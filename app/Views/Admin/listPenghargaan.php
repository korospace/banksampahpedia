...
<?= $this->section('contentJs'); ?>
	...
	<script src="<?= base_url('assets/js/admin.penghargaan.min.js'); ?>"></script>
<?= $this->endSection(); ?>
...
<?= $this->section('content'); ?>
				...
				<div class="container-fluid py-1 px-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
							...
							<li class="breadcrumb-item text-sm text-dark active" aria-current="page">Penghargaan</li>
						</ol>
						<h6 class="font-weight-bolder mb-0">Manage All Penghargaan</h6>
					</nav>
						...
						<div class="card mb-4 h-100 d-flex flex-column" style="max-height: 100%;overflow: hidden;font-family: 'qc-semibold';">
							...
							<div class="card-header form-row pb-0 mb-3 d-flex justify-content-end" style="font-family: 'qc-semibold';">
								<div class="input-group col-12 col-sm-1 p-0" style="min-width: 90px;">
									<button class="btn btn-success mt-4 mt-sm-0 text-xxs" data-toggle="modal" data-target="#modalAddPenghargaan" onclick="openModalAddPenghargaan()" style="width: 100%;">tambah</button>
								</div>
							</div>
							<!-- container table -->
							<div class="card-body px-0 pt-0 pb-2 position-relative" style="flex: 1;overflow: hidden;font-family: 'qc-semibold';">
								<div class="table-responsive p-0 position-relative" style="min-height: 100%;max-height: 100%;overflow: auto;font-family: 'qc-semibold';">
									<!-- spinner -->
									<div id="list-penghargaan-spinner" class="d-none position-absolute bg-white d-flex align-items-center justify-content-center pt-4" style="z-index: 10;top: 0;bottom: 0;left: 0;right: 0;">
										<img src="<?= base_url('assets/images/spinner.svg');?>" style="width: 30px;" />
									</div>
									<!-- message not found -->
									<div id="list-penghargaan-notfound" class="d-none position-absolute bg-white d-flex align-items-center justify-content-center pt-5" style="z-index: 10;top: 0;bottom: 0;left: 0;right: 0;">
										<h6 id="text-notfound" class='opacity-6'></h6>
									</div>
									<!-- table -->
									<table id="table-penghargaan" class="table table-striped text-center mb-0">
	...
	<!-- modals Add Penghargaan-->
	<div class="modal fade" id="modalAddPenghargaan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form id="formAddPenghargaan" class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						...
						<h6 class="font-italic opacity-8 mt-4 mb-2">Nama Penghargaan</h6>
						<div class="col-12 input-group">
							<input type="text" class="form-control px-2" id="penghargaan_name" name="penghargaan_name" autocomplete="off" placeholder="masukan kategori baru">
						</div>
						<small
						  id="penghargaan_name-error"
				...
				<div class="modal-footer">
					<button id="btnAddPenghargaan" type="submit" class="btn btn-success d-flex justify-content-center align-items-center" style="height: 40.8px;" onclick="addPenghargaan(this,event)">
