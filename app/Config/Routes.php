...
$routes->group("transaksi", function ($routes) {
  ...
  $routes->add('updatetblsetor',                  'Transaksi::updateTblSetorSampah');
  //API
  $routes->post("setorsampah",        "Transaksi::setorSampah");
  $routes->post("editsetorsampah",    "Transaksi::editSetorSampah");
  $routes->post("setorsampahapk",     "Transaksi::setorSampahApk");
  $routes->post("tariksaldo",         "Transaksi::tarikSaldo");
  $routes->post("tariksaldobst",      "Transaksi::tarikSaldo/bst");
